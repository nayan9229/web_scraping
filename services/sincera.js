...
const fs = require('fs');
const { insertCompany } = require('../utils/db');
...
async function start() {
  ...
  let pages = [430, 438, 439, 31, 8, 426, 71, 159, 91, 218, 632, 33, 554, 457, 458, 17, 77, 696, 74, 92, 388, 608, 556, 51, 340, 32, 390, 612, 432, 337,
